        ...
        <html>
            ...
            <body>
                <div className="jumbotron" style={{ 
                    backgroundImage: 'url(https://contents.kyobobook.co.kr/display/i_1624_450_7fa7ef7fb9444190a962041bfc81b81d.jpg)', 
                    backgroundSize: 'cover', 
                    backgroundPosition: 'center', 
                    backgroundRepeat: 'no-repeat' 
                }}> 
                    <div className="container" style={{ backgroundColor: 'rgba(0, 0, 0, 0)', padding: '20px', borderRadius: '10px' }}>
                        <h1 className="display-3" align="right" style={{fontWeight: 'bold'}}>카테고리별 도서 목록</h1>
                        <h5 className="display-5" align="right" style={{fontWeight: 'bold'}}>Category Book List</h5>
                    </div>
                </div>
